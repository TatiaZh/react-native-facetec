...
public class ZoomGlobalState {
    ...
    public static String DeviceLicenseKeyIdentifier = "dX2I5Yom1xG8kiwWbUZ55NkYnFYXdkzu";
    ...
    public static String ZoomServerBaseURL = "https://web-id-service.pulsar.ai/api/facetec";
